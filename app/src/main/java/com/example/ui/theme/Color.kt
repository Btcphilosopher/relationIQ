...
val M3SecondaryContainer = Color(0xFFD0BCFF)
val M3OnSecondaryContainer = Color(0xFF21005D)

val M3Background = Color(0xFFFEF7FF)
val M3OnBackground = Color(0xFF1D1B20)

val M3Surface = Color(0xFFFEF7FF)
...
val M3OutlineVariant = Color(0xFFE7E0EC)

// Standard / Dark mode fallback representations
